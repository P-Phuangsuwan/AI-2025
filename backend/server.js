...
app.post('/api/chat', async (req, res) => {
    try {
        ...
        const prompt = `คุณคือ AI ผู้ช่วยฟาร์มอัจฉริยะ (Smart Rice AI) ที่เชี่ยวชาญด้านการเกษตร สภาพอากาศ การทำนา และราคาข้าว 
คอยให้คำแนะนำชาวนาและเกษตรกรเกี่ยวกับการเกษตร
